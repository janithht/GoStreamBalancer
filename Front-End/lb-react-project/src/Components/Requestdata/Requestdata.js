                            ...
                            <TableBody>
                                {connections.map((conn, index) => (
                                    <TableRow key={index} className="table-row">
                                        <TableCell className="table-cell">{conn.client_ip}</TableCell>
                                        <TableCell className="table-cell">{conn.server_url}</TableCell>
                                        <TableCell className="table-cell">{conn.timestamp}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
